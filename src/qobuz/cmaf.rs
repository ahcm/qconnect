...
pub async fn setup_streaming(
    ...
    let content_key = crate::cmaf::unwrap_content_key(&session_key, key_str)
    ...
    let init_info = crate::cmaf::parse_init_segment(&init_data)
...
/// [`crate::cmaf::parse_init_segment`] to recover the FLAC header + segment

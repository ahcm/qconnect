...
pub fn sign_request(method: &str, kv_pairs: &[(&str, &str)], timestamp: u64, secret: &str)
-> String
{
...
pub fn sign_session_start(timestamp: u64) -> String
{
    ...
    crate::cmaf::compute_request_sig("sessionstart", &args, &timestamp.to_string(), CMAF_SEED)
}
...
pub fn sign_file_url(track_id: u64, format_id: u32, timestamp: u64) -> String
{
    ...
    crate::cmaf::compute_request_sig("fileurl", &args, &timestamp.to_string(), CMAF_SEED)
}
